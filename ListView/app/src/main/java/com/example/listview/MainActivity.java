...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adaptadorEjemplo = new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, ejemploslist);

        lista.setAdapter(adaptadorEjemplo);

        // EVENTO CLICK SOBRE CADA ELEMENTO DA LA LISTA.
